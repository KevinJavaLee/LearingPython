...
def toCSVFormat(list):
    ...
    try:
        ...
        # 转换成csv文件保存在本地
        # 不保存列名和索引
        data.to_csv("girls_info2.csv",mode="a",index=0,header=0)
...
def main():
    proxies = {"http":"http://119.123.245.3:9000"}
    for i in range(24655,30000):
        ...
        content = getHtmlConten(url,proxies)
